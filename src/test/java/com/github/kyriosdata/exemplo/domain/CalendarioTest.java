...
// Alterado por GFT AI Impact Bot: Removed 'public' modifier
class CalendarioTest {

    @Test
    void diaMenorQueUmInvalido() {
        assertThrows(IllegalArgumentException.class,
                () -> Calendario.diaDaSemana(0, 8, 2016));
    }

    @Test
    void diaMaiorQue31Invalido() {
        assertThrows(IllegalArgumentException.class,
                () -> Calendario.diaDaSemana(32, 8, 2016));
    }

    @Test
    void mesMenorQueUmInvalido() {
        assertThrows(IllegalArgumentException.class,
                () -> Calendario.diaDaSemana(1, 0, 2016));
    }

    @Test
    void mesMaiorQue12Invalido() {
        assertThrows(IllegalArgumentException.class,
                () -> Calendario.diaDaSemana(1, 13, 2016));
    }

    @Test
    void anoMenorQue1753Invalido() {
        assertThrows(IllegalArgumentException.class,
                () -> Calendario.diaDaSemana(31, 12, 1752));
    }

    @Test
    void anoIgualAoLimiteInferior() {
        assertEquals(0, Calendario.diaDaSemana(31, 12, 1753));
    }

    @Test
    void umDiaArbitrarioObtidoDeCalendario() {
